                ...
                >
                  <div className="row mt-5">
                    <div className="col-lg-6">
                      <div
                        className="card p-3 p-sm-5 contact mt-4 mb-5"
                        style={{ border: "  1px solid rgb(255 255 255 / 8%)" }}
                      >
                        <div className="card-body mb-4">
                          ...
                          <div className="body_content  mx-3 mt-3">
                            ...
                            <p className="w-100">
                              Experienced in building responsive, interactive
                              user interfaces with React, HTML, CSS, Bootstrap,
                              JavaScript, and jQuery. Over a year of experience
                              in developing dynamic web applications that
                              enhance user experience and meet business goals.
                            </p>

                            <h6 className="contact_info">
                              Phone: <span> 9080122807</span>
                            </h6>
                            <h6 className="contact_info">
                              Email: <span>gajapathi787gmail.com </span>
                            </h6>
                            ...
                            <div class="social">
                              ...
                              <div class="media d-flex justify-content-center align-items-center">
                                <a
                                  href="https://www.linkedin.com/in/k-gaja-pathi-b29a18271/"
                                  class="text-white"
                                  target="_blank"
                                  rel="noreferrer"
                                >
                    ...
                    <div className="col-lg-6">
                      <div
                        className="card p-3 p-sm-4 contact mt-4 mb-5"
                        style={{ border: "  1px solid rgb(255 255 255 / 8%)" }}
                      >
                        <div className="card-body mb-4">
                          <div className="row mt-4">
                            <div className="col-lg-12">
                              ...
                              <div className="input-grp mb-3">
                                <button className="custom_btn  w-100 p-3 mt-4">
                                  SEND MESSAGE{" "}
                                  <span className="ms-2">
                                    {" "}
                                    <FaArrowRight
