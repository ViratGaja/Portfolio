                    ...
                    <div className="col-lg-6 col-12">
                      <div className="education">
                        ...
                        <div className="card edu_info">
                          ...
                          <div>
                            <p className="mt-1 px-3 py-3 lorem">
                              During my Bachelor's degree in Computer Science
                              Engineering, I gained comprehensive knowledge in
                              core computer science concepts, programming
                              languages, and software development. Key
                              ...
                              <ul className="mt-3">
                                ...
                                <li className="mb-3">
                                  Specialized in web development, data
                                  structures, and algorithms
                                </li>
                                <li className="mb-3">
                                  Completed several hands-on projects using
                                  modern technologies
                                </li>
                                <li className="mb-3">
                                  Participated in technical workshops and coding
                                  competitions
                                </li>
                                <li className="mb-3">
                                  Developed strong problem-solving and
                                  analytical skills
                                </li>
                                <li className="mb-3">
                                  Active member of the college's coding club and
                                  technical society
                                </li>
                              </ul>
                            </p>
                        ...
                        <div className="card edu_info">
                          ...
                          <div>
                            <p className="px-3 py-3 lorem">
                              Completed Higher Secondary Certificate (HSC) with
                              Computer Science group, achieving excellent
                              academic performance. Key accomplishments include
                              strong foundation in Mathematics, Physics, and
                              Computer Science. Participated actively in school
                              activities and maintained consistent academic
                              records. Developed fundamental analytical and
                              problem-solving skills that prepared me for higher
                        ...
                        <div className="card edu_info">
                          ...
                          <div>
                            <p className="px-3 py-3 lorem">
                              Successfully completed Sec`ondary School Leaving
                              Certificate (SSLC) with excellent academic
                              performance. Developed strong foundation in core
                              subjects including Mathematics, Science, and
                              English. Actively participated in various school
                              activities and sports events. This fundamental
                              education phase helped build critical thinking and
                              analytical skills essential for higher studies.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="education">
                        ...
                        <div className="card edu_info">
                          ...
                          <div>
                            <p className="px-3 py-3 lorem">
                              I joined Thaagam Foundation a multinational
                              non-governmental organization, in September 2023
                              as web developer. In this role, I work with HTML,
                              CSS bootstrap, JavaScript, and Query to handle
                              front-end development aiso oversee the daily
                              operations of the organization, while actively
                              contributing to web development projects My
                              responsibilities include creating and updating
                              various modules on the Thaagam Foundation website
                              (www.thaagam.org)
                            </p>
                          </div>
                        </div>
